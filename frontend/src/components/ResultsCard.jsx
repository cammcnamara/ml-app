/**
 * Results card (final scene, right panel).
 *
 * Renders three states:
 * - Error: red banner with error text.
 * - Loading: spinner + \"Training models…\" placeholder.
 * - Results: one card per model with metrics listed.
 *
 * Props:
 * - result: object | null (backend response keyed by model id)
 * - training: boolean
 * - error: string
 */
  ...
  if (training) {
    return (
      <div className="results-empty">
        <span
          className="spinner"
          style={{ width: 20, height: 20, borderWidth: 2.5 }}
        />
